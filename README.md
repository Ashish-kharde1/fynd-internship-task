...
```
/
├── backend/            # FastAPI application (API, Database, AI Services)
├── user-dashboard/     # Customer-facing review submission UI (Next.js)
└── admin-dashboard/    # Internal analytics and monitoring UI (Next.js)
```
...
## ☁️ Deployment & Critical Information
...
### ⚠️ Important Note regarding Backend Deployment
